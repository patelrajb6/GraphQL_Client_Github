# Course Project
### Description: object-oriented pure functional design and implementation of an a [GraphQL](https://graphql.org) client framework for [Github](https://github.com/) as an I/O monad.
### Grade: 25%
